 ...
 * @param diskState  高四位的值表示硬盘类型，具体为：0 读写驱动器 1 只读驱动器 2 备份驱动器或媒体驱动器 3 冗余驱动器 4
 *                   快照驱动器；低四位的值表示硬盘的状态，0-休眠,1-活动,2-故障
 * @param diskNum    硬盘号
...
public class Single_Disk_Info_t {
	...
	public byte diskState; // 高四位的值表示硬盘类型，具体为：0 读写驱动器 1 只读驱动器 2 备份驱动器或媒体驱动器 3 冗余驱动器 4
							// 快照驱动器；低四位的值表示硬盘的状态，0-休眠,1-活动,2-故障
