...
public class IDpsdkCore {
    static {
        ...
        String osInfo = osName + ">>>" + osArch + ">>>" + osVersion;
        if (osInfo.indexOf("linux") >= 0 && osInfo.indexOf("amd64") >= 0) {
            String startupPath = MyScript.getAppPath() + "/dll_lib/centos_lib/";
            try {
                System.load(startupPath + "libDPSDK_Java.so");
                // System.load(startupPath + "libDPSDK_Java.so");
            } catch (UnsatisfiedLinkError ulink) {
                String msg = "Please Set environment variable $LD_LIBRARY_PATH";
                log.error(msg, ulink);
            }
        } else if (osInfo.indexOf("windows") >= 0 && osInfo.indexOf("amd64") >= 0) {
            ///String startupPath = MyScript.getAppPath() + "/dll_lib/w64_lib/";

            String startupPath = Const.getProjectPath() + "/dll_lib/w64_lib/";
            try {
                System.load(startupPath + "dslalien.dll");
                System.load(startupPath + "libdsl.dll");
                System.load(startupPath + "PicSDK.dll");
                System.load(startupPath + "Infra.dll");
                System.load(startupPath + "StreamParser.dll");
                System.load(startupPath + "StreamPackage.dll");
                System.load(startupPath + "StreamConvertor.dll");
                System.load(startupPath + "PlatformSDK.dll");
                System.load(startupPath + "DPSDK_Core.dll");
                System.load(startupPath + "DPSDK_Java.dll");

            } catch (UnsatisfiedLinkError ulink) {
                log.error("fatalError", ulink);
            }
        } else if (osInfo.indexOf("windows") >= 0) {
            String startupPath = MyScript.getAppPath() + "/dll_lib/w32_lib/";
            try {
                System.load(startupPath + "dslalien.dll");
                System.load(startupPath + "libdsl.dll");
                System.load(startupPath + "PicSDK.dll");
     ...
     * @remark
     */
    static public native int DPSDK_SetDPSDKDeviceChangeCallback(int nPDLLHandle,
            fDPSDKDeviceChangeCallback deviceChangeCallback);
     ...
     * @remark
     */
    static public native int DPSDK_SetDPSDKDeviceStatusCallback(int nPDLLHandle,
            fDPSDKDevStatusCallback deviceStatusCallback);
     ...
     * @remark 通道状态变化的时候会推送
     */
    static public native int DPSDK_SetDPSDKNVRChnlStatusCallback(int nPDLLHandle,
            fDPSDKNVRChnlStatusCallback nvrChnlStatusCallback);
     ...
     * @remark
     */
    static public native int DPSDK_LoadOrgInfoByType(int nPDLLHandle, int type, Return_Value_Info_t nOrgCount,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_LoadDGroupInfoLayered(int nPDLLHandle, Load_Dep_Info_t depInfo,
            Return_Value_Info_t nGroupLen, int nTimeout);
     ...
     * @param IN  nTimeout 超时时长，单位毫秒
     * @return 函数返回错误类型，参考dpsdk_retval_e
     * @remark 1、szGroupBuf需要在外面创建好 2、szGroupBuf的大小与nGroupLen需要一致或者大于nGroupLen
     */
     ...
     * @remark
     */
    static public native int DPSDK_GetEncChannelCount(int nPDLLHandle, byte szDeviceId[],
            Return_Value_Info_t nEncChannelCount);
     ...
     * @remark
     */
    static public native int DPSDK_GetChannelInfoById(int nPDLLHanle, byte szCameraId[],
     ...
     * @remark
     */
    static public native int DPSDK_GetLogicDepNodeNum(int nPDLLHandle, byte szDepCoding[], int nNodeType,
            Return_Value_Info_t nDepNodeNum);
     ...
     * @remark
     */
    static public native int DPSDK_GetLogicSubDepInfoByIndex(int nPDLLHandle, byte szDepCoding[], int nIndex,
            Dep_Info_Ex_t depInfoEx);
     ...
     * @remark
     */
    static public native int DPSDK_GetLogicID(int nPDLLHandle, byte szDepCoding[], int nIndex, boolean bChnl,
            Return_Value_ByteArray_t szCodeID);
     ...
     * @remark
     */
    static public native int DPSDK_GetRealStream(int nPDLLHandle, Return_Value_Info_t nRealSeq,
            Get_RealStream_Info_t getInfo, fMediaDataCallback cbMediaDataCallback, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_GetExternalRealStreamUrl(int nPDLLHandle,
            Get_ExternalRealStreamUrl_Info_t pExternalRealStreamUrlInfo, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_GetRealStreamUrl(int nPDLLHandle, Get_RealStreamUrl_Info_t pRealStreamUrlInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_GetTalkStream(int nPDLLHandle, Return_Value_Info_t nTalkSeq,
            Get_TalkStream_Info_t getInfo, fMediaDataCallback cbMediaDataCallback, int nTimeout);
     ...
     */
    static public native int DPSDK_QueryRecord(int nPDLLHandle, Query_Record_Info_t queryInfo,
            Return_Value_Info_t nRecordCount, int nTimeout);
     ...
     * @remark 1、nRecordCount最大5000个记录
     */
    static public native int DPSDK_QueryRecordByStreamType(int nPDLLHandle, Query_Record_Info_t queryInfo,
            int nStreamType, Return_Value_Info_t nRecordCount, int nTimeout);
     ...
     * @return 函数返回错误类型，参考dpsdk_retval_e
     * @remark 1、必须先查询后获取 2、DPSDK_QueryRecord会返回记录个数,
     */
     ...
     * @remark
     */
    static public native int DPSDK_GetRecordStreamByFile(int nPDLLHandle, Return_Value_Info_t nPlaybackSeq,
            Get_RecordStream_File_Info_t recordInfo, fMediaDataCallback cbMediaDataCallback, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_GetRecordStreamByTime(int nPDLLHandle, Return_Value_Info_t nPlaybackSeq,
            Get_RecordStream_Time_Info_t recordInfo, fMediaDataCallback cbMediaDataCallback, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_GetRecordStreamByStreamType(int nPDLLHandle, Return_Value_Info_t nPlaybackSeq,
            Get_RecordStream_Time_Info_t recordInfo, int nStreamType, fMediaDataCallback cbMediaDataCallback,
            int nTimeout);
     ...
     */
    static public native int DPSDK_SeekRecordStreamBySeq(int nPDLLHandle, int nPlaybackSeq, long lSeekBegin,
            long lSeekEnd, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_PtzCameraOperation(int nPDLLHandle, Ptz_Operation_Info_t operationInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_PtzLightControl(int nPDLLHandle, Ptz_Open_Command_Info_t ptzOpenCmdInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_PtzRainBrushControl(int nPDLLHandle, Ptz_Open_Command_Info_t ptzOpenCmdInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_PtzInfraredControl(int nPDLLHandle, Ptz_Open_Command_Info_t ptzOpenCmdInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_PtzPrePointOperation(int nPDLLHandle,
            Ptz_Prepoint_Operation_Info_t prePointOperation, int nTimeout);
     ...
     * @param IN  nTimeout 超时时长，单位毫秒
     * @return 函数返回错误类型，参考dpsdk_retval_e
     * @remark 1、需要2次函数调用才能最终获取设备列表信息。 2、先使用DPSDK_GetDeviceListLen，获取nDevListLen的值。
     ...
     * 
     * @param IN  nPDLLHandle SDK句柄
     * @param IN  szDevicesId
     *            需要查询的多个设备ID字符串数组,大小应为byte[nDevicesCount][DpsdkCoreDefine.DPSDK_CORE_DEV_ID_LEN]
     ...
     * @remark
     */
    static public native int DPSDK_GetDevicesInfoLen(int nPDLLHandle, byte szDevicesId[][], int nDevicesCount,
            Return_Value_Info_t nDevInfoLen, int nTimeout);
     ...
     */
    static public native int DPSDK_GetDevicesInfoStr(int nPDLLHandle, byte szDevicesInfo[], int nDevInfoLen,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_GetDeviceTypeByDevId(int nPDLLHandle, byte szDevId[],
            Return_Value_Info_t nDeviceType);
     ...
     */
    static public native int DPSDK_ControlVideoAlarmHost(int nPDLLHandle, byte szDeviceId[], int channelId,
            int controlType, int nTimeout);
     ...
     */
    static public native int DPSDK_ControlNetAlarmHostCmd(int nPDLLHandle, byte szId[], int opttype, int controlType,
            long iStart, long iEnd, int nTimeout);

    /**
     * 设置远程设备抓图回调
     */
    static public native int DPSDK_SetDPSDKRemoteDeviceSnapCallback(int nPDLLHandle,
     ...
     * 
     * @param IN  nPDLLHandle SDK句柄
     * @param IN  szJson Json字符串, 形如:"{ \"DevID\":
     *            \"1000000\",\"CameraId\":\"1000000$1$0$1\", \"DevChannel\":
     *            1,\"PicNum\": 1,\"CourtTime\": \"2014-09-17 16:00:00\"}"
     * @param OUT szJsonResult 平台返回的Json字符串,
     * @return 函数返回错误类型，参考dpsdk_retval_e
     * @remark
     */
    static public native int DPSDK_SendCammandToCMSByJson(int nPDLLHandle, byte[] szJson, byte[] szJsonResult,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_SendCammandToDMSByJson(int nPDLLHandle, byte[] szJson, byte[] szCamId,
            byte[] szJsonResult, int nTimeout);
     ...
     */
    static public native int DPSDK_QueryNetAlarmHostStatus(int nPDLLHandle, byte[] szDeviceId, int nChannelcount,
            dpsdk_AHostDefenceStatus_t[] defenceStatus, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_SetVideoAlarmHostStatusCallback(int nPDLLHandle,
            fDPSDKVideoAlarmHostStatusCallback fun);
     ...
     * @remark
     */
    static public native int DPSDK_SetBroadcastReportStatusCallback(int nPDLLHandle,
            fDPSDKBroadcastReportStatusCallback fun);
     ...
     * @remark
     */
    static public native int DPSDK_PhoneSubscribeAlarm(int nPDLLHandle, dpsdk_phone_subscribe_alarm_t userParam,
            Return_Value_Info_t nIsSubscribe, int nTimeout);
     ...
     * @remark 1、布控时需要明白不同的报警类型对应不同的参数
     */
    static public native int DPSDK_EnableAlarmByDepartment(int nPDLLHandle, Alarm_Enable_By_Dep_Info_t sourceInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_QueryAlarmCount(int nPDLLHandle, Alarm_Query_Info_t pQuery,
            Return_Value_Info_t nCount, int nTimeout);
     ...
     * @param IN    nTimeout 超时时长，单位毫秒
     * @return 函数返回错误类型，参考dpsdk_retval_e
     * @remark 1、支持分批获取 2、此接口推荐和DPSDK_QueryAlarmCount一起使用
     */
    static public native int DPSDK_QueryAlarmInfo(int nPDLLHandle, Alarm_Query_Info_t pQuery, Alarm_Info_t pInfo,
            int nFirstNum, int nQueryCount, int nTimeout);
     ...
     * @remark
     */
    // static public native int DPSDK_SetShareVideoCallback(int nPDLLHandle,
    // fDPSDKShareVideoCallback fun);
     ...
     * @remark
     */
    static public native int DPSDK_ShareVideo(int nPDLLHanle, ShareVideoInfo videoInfoArray[], int userIdArray[],
            byte[] szMsg, int nTimeout);
     ...
     */
    static public native int DPSDK_SetGeneralJsonTransportCallback(int nPDLLHandle,
            fDPSDKGeneralJsonTransportCallback fun);
     ...
     * @return 函数返回错误类型，参考{@link dpsdk_retval_e}
     */
    static public native int DPSDK_GeneralJsonTransport(int nPDLLHandle, byte[] szJson, int mdltype, int trantype,
            int nTimeout);
     ...
     *         IDpsdkCore.DPSDK_GetAlarmSchemeCount(m_nPDLLHandle, nCount,
     *         dpsdk_constant_value.DPSDK_CORE_DEFAULT_TIMEOUT); int nAlarmCount =
     *         nCount.nReturnValue;
     */
     ...
     *         IDpsdkCore.DPSDK_GetAlarmSchemeCount(m_nPDLLHandle, nCount,
     *         dpsdk_constant_value.DPSDK_CORE_DEFAULT_TIMEOUT); int nAlarmCount =
     *         nCount.nReturnValue; if (nAlarmCount > 0) { AlarmSchemeInfo_t[]
     *         alarmSchemeList = new AlarmSchemeInfo_t[nAlarmCount];
     *         IDpsdkCore.DPSDK_GetAlarmSchemeList(m_nPDLLHandle, alarmSchemeList,
     *         dpsdk_constant_value.DPSDK_CORE_DEFAULT_TIMEOUT); for (int i = 0; i <
     *         alarmSchemeList.length; ++i) { //do something } }
     */
    static public native int DPSDK_GetAlarmSchemeList(int nPDLLHandle, AlarmSchemeInfo_t[] alarmSchemeList,
            int nTimeout);
     ...
     *         IDpsdkCore.DPSDK_GetAlarmSchemeList(m_nPDLLHandle, alarmSchemeList,
     *         dpsdk_constant_value.DPSDK_CORE_DEFAULT_TIMEOUT); for (int i = 0; i <
     *         alarmSchemeList.length; ++i) { alarmSchemeList[i].status =
     *         dpsdk_alarmScheme_status_e.ALARM_SCHEME_STATUS_OPEN;
     *         IDpsdkCore.DPSDK_SaveAlarmScheme(m_nPDLLHandle, alarmSchemeList[i],
     *         dpsdk_constant_value.DPSDK_CORE_DEFAULT_TIMEOUT); } }
     */
     ...
     * @param IN nTimeout 超时时间
     * @return 函数返回错误类型，参考dpsdk_retval_e
     * @sample DPSDK_SendScsMsg(m_nPDLLHandle, "test".getBytes(), "test".getBytes(),
     *         dpsdk_constant_value.DPSDK_CORE_DEFAULT_TIMEOUT);
     */
     ...
     * @remark
     */
    static public native int DPSDK_GetTvWallLayoutCount(int nPDLLHandle, int nTvWallId, Return_Value_Info_t nCount,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_SetTvWallScreenWindowSource(int nPDLLHandle,
            Set_TvWall_Screen_Window_Source_t pWindowSourceInfo, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_CloseTvWallScreenWindowSource(int nPDLLHandle,
            TvWall_Screen_Close_Source_t pCloseSourceInfo, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_SetTvWallScreenSplit(int nPDLLHandle, TvWall_Screen_Split_t pSplitInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_TvWallScreenOpenWindow(int nPDLLHandle, TvWall_Screen_Open_Window_t pOpenWindowInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_ClearTvWallScreenByDecodeId(int nPDLLHandle, int nTvWallId, byte[] szDecodeId,
            int nTimeout);
     ...
     * @return 函数返回错误类型，参考dpsdk_retval_e.
     */
    static public native int DPSDK_GetTvWallTaskListCount(int nPDLLHandle, int nTVWallId, Return_Value_Info_t nCount,
            int nTimeout);
     ...
     * @return 函数返回错误类型，参考dpsdk_retval_e.
     */
    static public native int DPSDK_GetTvWallTaskList(int nPDLLHandle, int nTVWallId,
            TvWall_Task_Info_List_t pTVWallTaskInfoList, int nTimeout);
     ...
     * @return 函数返回错误类型，参考dpsdk_retval_e.
     */
    static public native int DPSDK_GetTvWallTaskInfoLen(int nPDLLHandle, int nTVWallId, int nTaskId,
            Return_Value_Info_t pTaskInfoLen, int nTimeout);
     ...
     * @return 函数返回错误类型，参考dpsdk_retval_e
     */
    // static public native int DPSDK_GetAlarmOutChannelCount( int nPDLLHandle,
    // byte
    // szDeviceId[], Return_Value_Info_t nCount);
     ...
     */
    // static public native int DPSDK_GetAlarmOutChannelInfo( int nPDLLHandle,
    // Get_AlarmOutChannel_Info_t pstruUserInfo);
     ...
     * @remark
     */
    // static public native int DPSDK_PtzCtrlOut( int nPDLLHandle,
    // Ptz_Ctrl_Out_Info_t pPtzCtrlOutInfo, int nTimeout );
     ...
     */
    // static public native int DPSDK_GetChannelBaseInfo( int nPDLLHandle, byte
    // szCameraId[], ChannelBase_Info_t pGetInfo );
     ...
     *         2、pEncChannelnfo的大小与DPSDK_GetDGroupInfo中通道个数返回需要一致
     */
    // static public native int DPSDK_GetPosChannelCount( int nPDLLHandle, byte
    // szDeviceId[], Return_Value_Info_t nPosChannelCount);
     ...
     *         2、pEncChannelnfo的大小与DPSDK_GetDGroupInfo中通道个数返回需要一致
     */
    // static public native int DPSDK_GetPosChannelInfo( int nPDLLHandle,
    // Get_PosChannel_Info_t getInfo );
     ...
     * @remark
     */
    static public native int DPSDK_SaveOptLog(int nPDLLHandle, byte szCameraId[], long optTime, int optType,
            byte optDesc[]);
     ...
     * @remark
     */
    static public native int DPSDK_AskForLastGpsStatusXMLStrCount(int nPDLLHandle, Return_Value_Info_t nGpsXMLLen,
            int nTimeout);
     ...
     */
    static public native int DPSDK_SetDPSDKGetBayCarInfoCallbackEx(int nPDLLHandle,
            fDPSDKGetBayCarInfoCallbackEx BayCarInfoCallback);

    /**
     * 订阅卡口过车信息上报.
     * 
     * @param IN nPDLLHandle SDK句柄
     * @param IN pGetInfo 订阅卡口过车信息上报请求信息，参考Subscribe_Bay_Car_Info_t 注意:
     *           如果订阅通道数nChnlCount为0(pEncChannelnfo要置NULL)， 表示所有通道的过车数据都上报.
     *           只有订阅以后picSDK的回调才能起作用。DPSDK_SetDPSDKGetBayCarInfoCallback才能回调给上层
     * @param IN nTimeout 超时时长，单位毫秒
     * @return 函数返回错误类型，参考dpsdk_retval_e
     * @remark
     */
    static public native int DPSDK_SubscribeBayCarInfo(int nPDLLHandle, Subscribe_Bay_Car_Info_t pGetInfo,
            int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_QueryPersonCount(int nPDLLHandle, byte szCameraId[], Return_Value_Info_t nQuerySeq,
            Return_Value_Info_t totalCount, int nStartTime, int nEndTime, int nGranularity, int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_QueryPersonCountBypage(int nPDLLHandle, byte szCameraId[], int nQuerySeq, int nIndex,
            int nCount, Person_Count_Info_t pPersonInfo[], int nTimeout);
     ...
     * @remark
     */
    static public native int DPSDK_StopQueryPersonCount(int nPDLLHandle, byte szCameraId[], int nQuerySeq,
            int nTimeout);
     ...
     * @return 函数返回错误类型，参考dpsdk_retval_e
     */
    static public native int DPSDK_SetDPSDKTrafficAlarmCallback(int nPDLLHandle,
            fDPSDKTrafficAlarmCallback TrafficAlarmCallback);
     ...
     * @remark
     */
    static public native int DPSDK_SetDPSDKGetAreaSpeedDetectCallback(int nPDLLHandle,
            fDPSDKGetAreaSpeedDetectCallback fun);
     ...
     * @remark
     */
    static public native int DPSDK_SaveRealStream(int nPDLLHandle, Return_Value_Info_t nRealSeq,
            Get_RealStream_Info_t getInfo, int scType, byte szFilePath[], int nTimeout);
     ...
     */
    static public native int DPSDK_GetRecordStreamByFile(int nPDLLHandle, Return_Value_Info_t nPlaybackSeq,
            Get_RecordStream_File_Info_t recordInfo, int scType, byte szFilePath[], int nTimeout);
     ...
     */
    static public native int DPSDK_GetRecordStreamByTime(int nPDLLHandle, Return_Value_Info_t nPlaybackSeq,
            Get_RecordStream_Time_Info_t recordInfo, int scType, byte szFilePath[], int nTimeout);
}
