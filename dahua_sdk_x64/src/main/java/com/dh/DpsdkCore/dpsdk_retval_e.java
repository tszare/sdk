 ...
 * @param DPSDK_RET_UNKNOWN_SESSION                     = 16 无效的session
 *                                                      fixme:检查已有情况统一为此应答
 * 
 ...
 * 
 * @param SERVER_RET_CMS_ERR_BEGIN                      = 1000000
 *                                                      CMS返回开始，不做返回值判断
 * @param SERVER_RET_CMS_ERR_QUERY_PU_SUCCESS           = 1000001
 *                                                      查询全部录像时只有前端查询成功
 * @param SERVER_RET_CMS_ERR_QUERY_CENTER_SUCCESS       = 1000002
 *                                                      查询全部录像时只有中心查询成功
 * 
 * @param SERVER_RET_CMS_CLIENT_ERROR_BEGIN             = 1000420
 ...
 * 
 * @param SERVER_RET_CMS_SERVER_ERROR_BEGIN             = 1000520
 *                                                      CMS服务协议返回开始，不做返回值判断
 ...
 * @param SERVER_RET_CMS_ERR_ENCODE_PDU                 = 1000551
 *                                                      CMS在准备应答时候，进行Encode操作失败
 * @param SERVER_RET_CMS_ERR_DECODE_PDU                 = 1000552
 *                                                      CMS在准备应答时候，进行Decode操作失败
 ...
 * @param SERVER_RET_DMS_ERR_PTZ_ACCESS_FAILED          = 1001525
 *                                                      象云台协商管理模块请求访问失败
 * @param SERVER_RET_DMS_ERR_TCP_COMM_NO_CLIENT         = 1001526
 *                                                      用户连接没有绑定到授权的客户端
 ...
 * @param SERVER_RET_DMS_ERR_NORMAL_LOCK_FAILED         = 1001532
 *                                                      需要Server检查的Lock失败错误
 * @param SERVER_RET_DMS_ERR_OCCUPY_BY_OTHER_USER       = 1001533 被其他用户占用
 * @param SERVER_RET_DMS_ERR_NORMAL_UNLOCK_FAILED       = 1001534
 *                                                      需要Server检查的UnLock失败错误
 ...
 * @param SERVER_RET_VMS_SERVER_ERROR_BEGIN             = 1002520
 *                                                      VMS服务协议返回开始，不做返回值判断
 ...
 * @param SERVER_RET_MS_ERR_ADD_RTP_SESSION_FAILED      = 1005528 添加RTP
 *                                                      SESSION到serverbase失败
 ...
 * @param SERVER_RET_MS_ERR_SNAP_STORE_PATH_INVALID     = 1005535
 *                                                      设置的SS端SNAP存储路径有问题
 ...
 * @param SERVER_RET_MS_ERR_IFRAME_2_BMP                = 1005538
 *                                                      SS在转换I帧到BMP时候失败
 * @param SERVER_RET_MS_ERR_DUPLICATE_PLAN_FOUND        = 1005539 重复的PlanId发现
 * @param SERVER_RET_MS_ERR_SDK_CALLBACK_TIMEOUT        = 1005540
 *                                                      SDK调用Callback超时，没有返回数据
 * @param SERVER_RET_MS_ERR_NOT_FOUND_SESSION_ID        = 1005541
 *                                                      未找到camera_session_id
 ...
 * 
 * @param SERVER_RET_PCS_ERR_BEGIN                      = 1006000
 *                                                      PCS服务协议返回开始，不做返回值判断
